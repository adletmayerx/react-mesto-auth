  ...
  return (
    <div className="register">
      ...
      <form name="register" className="form register__form">
        <input name="email" type="email" className="register__input input input_type_email" placeholder="Email" />
        <input name="password" type="password" className="register__input input input_type_password" placeholder="Пароль" />
